...
<?php }} ?>
                    ...
                    <ul class='pagination'>
                      ...
                      $sql1="SELECT * FROM post where category=$id1";
                      ...
                      echo '<li><a href="single.php?page='.($page+1).'">Next</a></li>';
                      }
                      ...
                      echo '<li class='.$active.'><a href="single.php?page='.$i.'">'.$i.'</a></li>';
                      }
                      if($page>1){
                      echo '<li><a href="single.php?page='.($page-1).'">Prev</a></li>';
                      }
                      echo "</ul>";
                      }
                       ?>
