...
/* -------Mysqli Connect Error Function-------*/
    $conn = mysqli_connect("localhost1","root","","") or die("Connection Failed: " . mysqli_connect_error());


/* -------Mysqli Connect Errorno Function-------*/
    $conn = mysqli_connect("localhost","root","","") or die("Connection Failed: " . mysqli_connect_errno());
